# RxMVVM
[ ![Download](https://api.bintray.com/packages/bitsecho/maven/rxmvvm-base/images/download.svg?version=1.1.1) ](https://bintray.com/bitsecho/maven/rxmvvm-base/1.1.1/link)
...
## Installation
```gradle
implementation 'com.bitsecho.rxmvvm:rxmvvm-base:1.1.1'
```
